...
$dadosSpace = $pdo->prepare("SELECT * FROM space INNER JOIN frame ON space.frame_idFrame = frame.idFrame WHERE space.idSpace = ? AND user_idUser = ?");
$dadosSpace->bindValue(1, $idSpace);
$dadosSpace->bindValue(2, $dadosUser['idUser']);
$dadosSpace->execute();

$dataSpace = $dadosSpace->fetch(PDO::FETCH_ASSOC);
...
if(isset($_POST['updateSpace'])){
    ...
    $space->updateSpace($nameSpace, $idSpace, $idFrame);
}
    ...
    <div class="row">
        ...
        <div class="data">
            <div class="col-xs-10">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form action="edit_Space.php" method="POST" class="form-horizontal">
                        <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-10">
                                <div class="form-group">
                                    <input type="text" value="<?php echo $dataSpace['zone'] ?>" class="form-control insertedData" name="zone" readonly="" required="">
                                </div>  
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-10">
                                <div class="form-group">
                                    <input type="hidden" value="<?php echo $dataSpace['idFrame'] ?>" name="idFrame" />
                                    <input type="text" value="<?php echo $dataSpace['nameSpace'] ?>" class="form-control insertedData" name="nameSpace"  required="">
                                </div>  
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-xs-2">
                                <input type="submit" name="updateSpace" class="btnEnfoca btn-primary" id="atualizar"value="Atualizar" />
                            </div>
                        </div>
                        </form>
